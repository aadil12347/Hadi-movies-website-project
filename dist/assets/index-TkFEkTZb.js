(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function r(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=r(o);fetch(o.href,s)}})();function R(e,t,r){const a=`
  ...
  `;e.innerHTML=a,e.querySelectorAll(".poster-card").forEach(o=>{o.addEventListener("click",()=>{const s=o.getAttribute("data-id"),i=r.find(l=>l.id==s);i&&t(i)})})}let b="home",M="all";const oe=["Action","Sci-Fi","Drama","Adventure","Anime","Comedy","Horror","Fantasy","Crime"];function w(e){const t=document.getElementById("playerModalContainer"),r=re(e.id);ee(t,e,a=>{ae(a),b==="watchlist"&&P(document.getElementById("mainContent"),w)},r)}function se(){const e=document.getElementById("searchModalContainer");te(e,w)}function j(){const e=document.getElementById("mainContent");if(e.innerHTML="",b==="watchlist"){P(e,w),window.scrollTo({top:0,behavior:"smooth"});return}const t=document.createElement("div");t.id="heroWrapper",e.appendChild(t);const r=b==="movie"?x():b==="tv"?B():b==="anime"?T():H;G(t,r,w,w);const a=document.createElement("div");a.id="genreWrapper",e.appendChild(a),Q(a,oe,M,s=>{M=s,j()});const o=N(b==="home"?"all":b,M);if(b==="home"&&M==="all")E(e,"🔥 Trending Movies",x().slice(0,12),"movie",U,w),E(e,"📺 Popular TV Series",B().slice(0,12),"tv",F,w),E(e,"⚡ Latest Anime Releases",T().slice(0,12),"anime",V,w);else{const s={home:`Results (${o.length})`,movie:`Movies (${o.length})`,tv:`TV Series (${o.length})`,anime:`Anime (${o.length})`};Z(e,s[b],o,w)}window.scrollTo({top:0,behavior:"smooth"})}async function ne(){await Promise.all([U(),F(),V()])}function ie(){const e=document.getElementById("headerApp");R(e,r=>{b=r,M="all",j()},se),ne().then(()=>{j()});const t=document.getElementById("scrollTopBtn");window.addEventListener("scroll",()=>{window.scrollY>300?t==null||t.classList.add("visible"):t==null||t.classList.remove("visible")}),t==null||t.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})})}document.addEventListener("DOMContentLoaded",ie);
